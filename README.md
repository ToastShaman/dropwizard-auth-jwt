...
* Updated upstream dependencies to Dropwizard 1.2.2
* Updated some upstream dependencies and plugins
* Removed explicit versions which shadow dependency managed versions
